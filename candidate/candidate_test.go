...
func TestCandidateConsensus(t *testing.T) {
	candidateConsensusTestCase(t, 3, false)
}
...
func candidateConsensusTestCase(t *testing.T, n int, firstCandidateShouldLead bool) (attempts int, duration time.Duration) {
